    ...
    <div class="container">
      <div class="wrapper">
        ...
        <div class="box-body">
          <div class="address">
            <div class="text">
              <div class="none" v-if="!curAddress">您需要先填寫收貨地址才可提交訂單。</div>
              <ul v-else>
                <li>
                ...
                <li>
                  <span>收貨地址：</span>{{ curAddress.fullLocation }} {{ curAddress.address }}
                </li>
              </ul>
            </div>
            <div class="action">
        ...
        <div class="box-body">
          <a class="my-btn active" href="javascript:;">不限發貨時間：周一至周日</a>
          <a class="my-btn" href="javascript:;">工作日發貨：周一至周五</a>
          <a class="my-btn" href="javascript:;">休、例假日發貨：周六至周日</a>
        </div>
        <!-- 支付方式 -->
        ...
        <div class="box-body">
          ...
          <span style="color: #999">貨到付款需額外支付手續費</span>
        </div>
        <!-- 金額明細 -->
